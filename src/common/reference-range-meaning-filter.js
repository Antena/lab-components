 ...
 * @example
 ...
 <p>{{example.observation.referenceRange[0].meaning.coding[0].code}}: <strong>{{ example.observation.referenceRange[0].meaning | referenceRangeMeaning }}</strong></p>
 <p>{{example.observation.referenceRange[0].meaning.coding[0].code}} (translated): <strong>{{ example.observation.referenceRange[0].meaning | referenceRangeMeaning | translate }}</strong></p>
